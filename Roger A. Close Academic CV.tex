...
\usepackage[top=1.2in, bottom=2in, right=0.9in, left=0.9in]{geometry}
...
28 Townsend Sq {\large\textperiodcentered} Oxford {\large\textperiodcentered} OX4 4BB {\large\textperiodcentered} UK\\ % Your mailing address
{\Large\Letter} roger.close@earth.ox.ac.uk \ {\Large\Telefon} 07752 927887 % Your email address and phone number
}
